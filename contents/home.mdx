...
<div className="tw:tablet:flex tw:tablet:flex-row tw:flex-col tw:items-center tw:place-content-center tw:space-x-5 tw:mb-5">
  <a href="https://www.tasa.org.tw" className="tw:tablet:w-1/3 tw:w-1/2" target="_blank">
    <img src="https://scidm.nchc.org.tw/uploads/group/2023-01-12-062522.720280TASA-.png" />
  </a>
</div>
...
<div className="tw:tablet:flex tw:tablet:flex-row tw:flex-col tw:items-center tw:place-content-center tw:space-x-5 tw:mb-5">
    <a href="https://www.phys.ntu.edu.tw/Default.html" className="tw:tablet:w-1/3 tw:w-1/2" target="_blank">
